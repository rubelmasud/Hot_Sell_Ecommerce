...
const Banner = () => {
    return (
        <div className='grid md:grid-cols-2 justify-between md:gap-4 items-center md:my-12 mt-6'>
            <div className="flex flex-col md:gap-3 md:text-start text-center">
                ...
                <div className="justify-start">
                    <button className='text-lg  bg-slate-400 w-fit md:px-4 px-2 md:py-1 my-4 text-white md:animate-bounce'>Shop now</button>
                </div>
            </div>
